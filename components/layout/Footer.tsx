      ...
      <div className="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 md:py-12 lg:py-14 xl:py-16">
        <div className="grid items-start gap-8 sm:gap-8 gap-y-10 md:grid-cols-2 lg:grid-cols-7 xl:grid-cols-6 lg:gap-x-6 xl:gap-x-8 2xl:gap-x-12">
          ...
          <div className="md:col-span-2 lg:col-span-2 min-w-0">
            ...
            >
              <div className="w-[68px] h-[68px] rounded-2xl bg-white flex items-center justify-center shadow-[0_8px_24px_-12px_rgba(255,255,255,0.4)] group-hover:shadow-[0_12px_32px_-12px_rgba(91,170,184,0.5)] transition-shadow">
                <img src="/logo.png" alt="DownForge" className="h-11 w-11 object-contain scale-110" />
              </div>
