          ...
          {plans.map((plan, i) => {
            ...
            return (
              <motion.div
                ...
                className={`relative flex flex-col rounded-[1.75rem] sm:rounded-[2rem] border overflow-hidden ${
                  isPro
                    ? "bg-[#0d1f26] dark:bg-[#0a1218] border-[#0d1f26] dark:border-white/10 shadow-[0_24px_64px_-16px_rgba(13,31,38,0.35)] lg:scale-[1.03] xl:scale-[1.04] z-10"
              ...
              >
                ...
                {isPro && (
                  <motion.span
                    ...
                    className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#5baab8] to-[#3d8896] text-white text-[10px] sm:text-xs font-black tracking-[0.1em] uppercase px-3.5 sm:px-4 py-1 sm:py-1.5 rounded-full shadow-md whitespace-nowrap"
                  >
