...
export function ThumbnailHero({ platform }: { platform: string }) {
  ...
  const formats: ApiFormatInfo[] = resolveFormats(mediaInfo, "thumbnail");
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                    <div className="bg-white/50 dark:bg-white/5 rounded-xl p-3 border border-border/50">
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider mb-1">Resolution</p>
                      <p className="text-sm font-semibold text-foreground">
                        {mediaInfo.thumbnail ? "Max Available" : "N/A"}
                      </p>
                    </div>
                    <div className="bg-white/50 dark:bg-white/5 rounded-xl p-3 border border-border/50">
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider mb-1">Format</p>
                      <p className="text-sm font-semibold text-foreground">
                        {formats[selectedFormat]?.ext?.toUpperCase() || "JPG"}
                      </p>
                    </div>
                    <div className="bg-white/50 dark:bg-white/5 rounded-xl p-3 border border-border/50">
                      <p className="text-[10px] font-mono text-muted-foreground uppercase tracking-wider mb-1">Video Title</p>
                      <p className="text-sm font-semibold text-foreground truncate" title={mediaInfo.title}>
