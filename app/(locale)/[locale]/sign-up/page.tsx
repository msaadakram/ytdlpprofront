...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  // since their canonical URL is the top-level /sign-up.
  if (locale !== "en") {
    return { alternates: { canonical: `https://www.downforge.me/sign-up` }, robots: { index: false, follow: false } };
  }
...
// locale-stripped /sign-up, so navigation from localized pages keeps the
