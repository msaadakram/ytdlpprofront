...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const languages = { en: `https://www.downforge.me/privacy`, "x-default": `https://www.downforge.me/privacy` };
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://www.downforge.me/privacy`, languages },
    openGraph: {
      title,
      description,
      type: "website",
      siteName: "DownForge",
      locale: "en_US",
      url: `https://www.downforge.me/privacy`,
    },
  };
}
