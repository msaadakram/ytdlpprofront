      ...
      <main className="pt-16 sm:pt-20">
        ...
        <section className="bg-[#0d1f26] text-white relative overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/10 px-3 py-1.5 mb-4">
            ...
            <p className="mt-4 inline-flex items-center gap-2 text-xs font-medium text-white/50 bg-white/5 border border-white/10 rounded-full px-3 py-1.5">
              ...
              <div className="rounded-[1.75rem] bg-white dark:bg-white/[0.04] border border-border/60 dark:border-white/10 shadow-sm overflow-hidden">
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  <div className="prose prose-sm sm:prose-base dark:prose-invert max-w-none prose-headings:font-heading prose-headings:tracking-tight prose-p:font-sans prose-p:leading-relaxed prose-a:text-[#5baab8] hover:prose-a:text-[#0d1f26] dark:hover:prose-a:text-white">
                    {sections.map((s) => (
                      <section key={s.id} id={s.id} className="scroll-mt-24 py-6 first:pt-0 border-b border-border/50 last:border-0">
                        <h2 className="text-lg sm:text-xl font-bold text-foreground !mb-3">{s.title}</h2>
                        <p className="text-sm sm:text-[15px] leading-relaxed text-muted-foreground !mt-0">{s.body}</p>
                      </section>
                    ))}
                  </div>
                  <div className="mt-8 flex flex-wrap gap-3">
                    <Link href="/privacy" className="inline-flex items-center gap-2 text-sm font-semibold bg-[#0d1f26] dark:bg-white text-white dark:text-[#0d1f26] px-5 py-2.5 rounded-full hover:bg-[#1a3545] dark:hover:bg-slate-100 transition-colors">
