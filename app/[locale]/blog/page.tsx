...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (locale !== "en") {
    return {
      alternates: { canonical: `https://www.downforge.me/en/blog` },
      robots: { index: false, follow: false },
    };
  }
  const t = await getTranslations({ locale: "en", namespace: "Blog" });
  const languages = { en: `https://www.downforge.me/en/blog`, "x-default": `https://www.downforge.me/en/blog` };
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: { canonical: `https://www.downforge.me/en/blog`, languages },
    openGraph: { title: t("metaTitle"), description: t("metaDescription"), type: "website", siteName: "DownForge", locale: "en_US", url: `https://www.downforge.me/en/blog` },
  };
}
...
export default async function BlogPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    url: `https://www.downforge.me/en/blog`,
  };
