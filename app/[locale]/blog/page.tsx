...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const languages = Object.fromEntries(routing.locales.map((l) => [l, `https://www.downforge.me/${l}/blog`]));
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: { canonical: `https://www.downforge.me/${locale}/blog`, languages },
...
export default async function BlogPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    url: `https://www.downforge.me/${locale}/blog`,
  };
