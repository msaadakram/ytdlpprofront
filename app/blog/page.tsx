...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.downforge.me/blog`, languages },
    openGraph: { title: t("metaTitle"), description: t("metaDescription"), type: "website", siteName: "DownForge", locale: "en_US", url: `https://www.downforge.me/blog` },
  };
}
...
export default async function BlogPage() {
  ...
  const jsonLd = {
    ...
    url: `https://www.downforge.me/blog`,
  };
